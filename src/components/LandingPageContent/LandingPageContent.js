...
function LandingPageContent(){
    return (
        <div className="landingpagecontent_container">
            ...
            <p className="landingpagecontent_subtitle">Watch from anywhere. Cancel at anytime
            </p>
            ...
            <div className="landingpagecontent_input">
                <input type ="text" />
                <Link to={'/sign-in'}>    <button className="landingpagecontent_button">GET STARTED</button>
                </Link>
